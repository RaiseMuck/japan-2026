  ...
  days: [
    ...
    { date:"2026-08-12", stayId:"stay-shiodome", title:"RAIN DAY — Skytree indoor", status:"locked",
      anchors:[
        ...
        { time:"11:00", title:"Shiodome → Tokyo Skytree", hard:false, note:"~20 min. Toei Asakusa Line from Shimbashi → Asakusa, then one stop on Tobu. Or one taxi if the rain is heavy — 68mm is not drizzle." },
      ...
      candidates:[
        ...
        { id:"act-solamachi", bucket:"activity", title:"Tokyo Solamachi — same building", walk:"same complex as the aquarium", cost:"¥",
          tags:["shopping","indoor","food"], tip:"300+ shops and a whole restaurant floor, all under one roof. Covers lunch, dinner and more clothes shopping without stepping outside. This is what makes the aquarium a full day instead of 3 hours.",
      ...
      bench:[
        { replaces:"act-sumida-aq", alt:"GINZA department stores — 15 min WALK from the hotel", why:"The lowest-rain-exposure option of all. Mitsukoshi, Matsuya, the Uniqlo and Muji flagships — all indoor, all connected to the subway. Do this instead if you'd rather not travel across town at all." },
      ...
      notes:"⚠ NIKKO CANCELLED 2026-08-11 — 68mm of rain forecast across Tokyo AND Nikko, heaviest overnight into Wednesday. The day was Kegon Falls + ropeway + Senjogahara boardwalk, all of which are views and outdoor walking. Swapping Nikko to Aug 11 was checked and also ruled out — the rain is already arriving today. Nikko is lost for this trip; it goes in the idea log for a future one. Sumida Aquarium moved up from Aug 22 to fill the day. HISTORICAL NOTE: the old plan said 15:26 was the last express — that came from a SATURDAY timetable used as a proxy and it was wrong. A live Wednesday check shows expresses at 17:22 and 17:44. You have ~2 MORE HOURS in Nikko than the earlier plan assumed, so Chuzenji no longer has to be rushed and Kanaya can be a real sit-down lunch. All Area Pass ¥8,000/adult — NOT the ¥3,000 World Heritage pass, which doesn\'t reach Chuzenji. No Fuji view from Nikko; Fuji rests on the seat-E Shinkansen legs." },
