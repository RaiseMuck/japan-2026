...
const TRIP = {
  ...
  days: [
    ...
    { date:"2026-08-11", stayId:"stay-shiodome", title:"Harajuku + Shinjuku", status:"locked",
      ...
      notes:"✅ ACTUAL: Ginza pancake cafe breakfast → Zara → LIB leather store (wallet) → train to Harajuku → Brandy Melville → back to Shiodome → gyudon chain dinner. Rained most of the day; the indoor Ginza-first shape worked better than the plan. ⚠ SHINJUKU NEVER HAPPENED — no TMG observation deck, no Omoide Yokocho, no Don Quijote, no Tsunahachi. See the skyview note in Ref. ⚠ Suitcase forwarded 22:00 — past the usual afternoon Takkyubin cutoff, so it likely went out Aug 12. CHECK THE TRACKING SLIP for the delivery date. Original plan follows: Harajuku will be busy; get there as early as you manage. Order deliberately flipped: Harajuku (19:00 close) before Shinjuku (nothing closes). Dinner budget was recut to $32pp on Aug 8 — the trip affords ONE splurge and that's Motoyama on Aug 21, so Sushi Tokyo Ten and Azabu are both off." },

    /* ═══════════════ Aug 12 ═══════════════ */
    { date:"2026-08-12", stayId:"stay-shiodome", title:"RAIN DAY — Skytree indoor", status:"locked",
      anchors:[
        { time:"10:00", title:"⚠ NIKKO CANCELLED — 68mm rain", hard:false, note:"Kegon Falls, the ropeway and Senjogahara are all views and boardwalk — worthless in this. ¥8,000/person pass NOT bought, so nothing lost but the day. No alarm needed." },
        { time:"11:00", title:"⚑ KAPPABASHI FIRST — knife street, it's ON the way", hard:false, note:"ROUTE: walk 7 min to SHIMBASHI → Toei Asakusa Line direct to ASAKUSA (~15 min) → walk 10 min WEST to Kappabashi. Asakusa is your Skytree transfer anyway, so this is a 10-min detour from a station you're standing in. DO IT FIRST — most Kappabashi shops close 17:00–18:00, the aquarium's last entry is 19:00. Same logic as Brandy Melville yesterday." },
        { time:"15:00", title:"Kappabashi → Skytree", hard:false, note:"Walk back to Asakusa (or Tawaramachi) → Tobu, ONE STOP, ~3 min → Tokyo Skytree. Taxi if the rain is heavy." },
        { time:"19:00", title:"Back toward Shiodome, or stay out at Solamachi", hard:false, note:"Solamachi has 300+ shops and a full restaurant floor — you can eat there and never go outside. Aquarium last entry is 19:00, so be in by then." },
      ],
      candidates:[
        { id:"act-kappabashi", bucket:"activity", title:"⚑ Kappabashi — the knife", walk:"10 min west of Asakusa Stn", cost:"¥7,500–15,000 target",
          tags:["shopping","knife","closes-early"], tip:"800m street, 16 knife shops, between Asakusa and Ueno. ASK FOR: santoku (三徳), 165–180mm, STAINLESS or stainless-clad — NOT full carbon, it rusts if you look at it wrong. VG-10 steel is the workhorse. Tojiro DP ~¥7,000–8,000 is the value standard. SHOPS: Kama-Asa (since 1908, ENGLISH-SPEAKING staff — start here), Cutlery Tsubaya (good clearance bin ~¥5,600), Union Commerce (widest brand range). PASSPORT = tax-free over ¥5,500. ⚠ Shops close 17:00–18:00.",
          link:"https://maps.google.com/?q=Kappabashi+Kitchen+Town" },
        { id:"act-sumida-aq", bucket:"activity", title:"Sumida Aquarium — the AMANO one ⚑ MOVED HERE FROM AUG 22", walk:"Skytree Town Solamachi 5–6F", cost:"~¥2,500",
          tags:["aquarium","aquascaping","indoor","anchor"], tip:"WEDNESDAY hours 10:00–20:00, LAST ENTRY 19:00. Takashi Amano designed the nature aquariums — one of only THREE worldwide with ADA-designed tanks (others: Lisbon, Sapporo). Budget 2–3h. Fully indoor.",
          link:"https://maps.google.com/?q=Sumida+Aquarium+Tokyo+Skytree" },
        { id:"act-solamachi", bucket:"activity", title:"Tokyo Solamachi — same building", walk:"same complex as the aquarium", cost:"¥",
          tags:["shopping","indoor","food","clothes"], tip:"300+ shops and a full restaurant floor, all under one roof. CLOTHES — the Zara-equivalent Japanese brands to look for: GU (Uniqlo's cheaper, trendier sister — the closest match to Zara), niko and…, Global Work, Lowrys Farm. Step up: Nano Universe, Journal Standard. Covers lunch, dinner and shopping without stepping outside.",
          link:"https://maps.google.com/?q=Tokyo+Solamachi" },
        
        { id:"food-solamachi", bucket:"food", title:"Solamachi restaurant floor — lunch AND dinner", walk:"same building", cost:"¥–¥¥",
          tags:["lunch","dinner","indoor"], tip:"Whole floor of restaurants. Zero rain exposure. No booking needed.",
          link:"https://maps.google.com/?q=Tokyo+Solamachi+restaurants" },
      ],
      bench:[
        { replaces:"act-kappabashi", alt:"KNIFE FALLBACK — Doguyasuji, Namba, OSAKA · 2 stops from Hommachi on the Midōsuji Line", why:"If Kappabashi doesn't happen today, this is the equivalent and it's easier: 2 subway stops from your Osaka hotel, 5 min from Dotonbori, fits any of the Aug 14/15/16 afternoon gaps. Much of what's sold there is Sakai-forged — Sakai is THE Japanese knife city and it's next door to Osaka. Shops close ~18:00–19:00, so make it an afternoon, not an evening." },
        { replaces:"act-solamachi", alt:"CLOTHES CHEAT SHEET — GU · niko and… · Global Work · Lowrys Farm · WEGO", why:"GU is the closest thing to Zara: same trend pieces, cheaper, it's Uniqlo's sister brand. niko and… and Global Work are casual everyday. Lowrys Farm is women's. WEGO is cheap and trend-heavy. Step up from there: Nano Universe, Journal Standard, Beams, Ships — the 'select shop' tier, which has no real US equivalent." },
        { replaces:"act-sumida-aq", alt:"GINZA department stores — 15 min WALK from the hotel", why:"The lowest-rain-exposure option of all. Mitsukoshi, Matsuya, the 12-floor UNIQLO flagship, the GU flagship, Tokyu Plaza Ginza. All indoor. Do this instead if you'd rather not cross town." },
        { replaces:"act-sumida-aq", alt:"Advertising Museum Tokyo (ADMT), Caretta Shiodome — 5 min, FREE", why:"Literally next door to the hotel. Free, indoor, genuinely good. The zero-effort option if the rain is bad enough that you don't want to leave the block." },
        { replaces:"act-sumida-aq", alt:"Kabukiza Theatre, Ginza — single-act tickets", why:"Indoor, walkable, and the one traditional-culture thing the trip otherwise has no slot for. Single-act tickets are sold same-day so you don't need to commit." },
        { replaces:"act-solamachi", alt:"Skip the Skytree observation deck", why:"It's in the same building and it's tempting, but you'd be paying to look at cloud. Save it — the trip's skyview box was already ticked in Shinjuku." },
      ],
      notes:"TODAY'S ORDER: Kappabashi (closes ~17:00) → Skytree → aquarium (last entry 19:00) → Solamachi for clothes + dinner. ⚠ THE KNIFE MUST BE CHECKED BAGGAGE on Aug 23 — your suitcase is in Osaka, so keep it WRAPPED with the RECEIPT in the daypack until you reunite. Japan's carry laws are strict but a wrapped new purchase with a receipt is unambiguously fine. ⚠ NIKKO CANCELLED 2026-08-11 — 68mm of rain forecast across Tokyo AND Nikko, heaviest overnight into Wednesday. The day was Kegon Falls + ropeway + Senjogahara boardwalk, all of which are views and outdoor walking. Swapping Nikko to Aug 11 was checked and also ruled out — the rain is already arriving today. Nikko is lost for this trip; it goes in the idea log for a future one. Sumida Aquarium moved up from Aug 22 to fill the day. HISTORICAL NOTE: the old plan said 15:26 was the last express — that came from a SATURDAY timetable used as a proxy and it was wrong. A live Wednesday check shows expresses at 17:22 and 17:44. You have ~2 MORE HOURS in Nikko than the earlier plan assumed, so Chuzenji no longer has to be rushed and Kanaya can be a real sit-down lunch. All Area Pass ¥8,000/adult — NOT the ¥3,000 World Heritage pass, which doesn\'t reach Chuzenji. No Fuji view from Nikko; Fuji rests on the seat-E Shinkansen legs." },
    ...
    { date:"2026-08-13", stayId:"stay-hommachi", title:"Tokyo → Osaka", status:"locked",
      ...
      bench:[
        ...
        { replaces:"act-nakanoshima", alt:"⚑ ABENO HARUKAS 300 — Japan's tallest building · ¥2,000 (~$13) · glass-covered deck", why:"BACK ON THE TABLE as of Aug 11. This was ruled out weeks ago because Shinjuku's free deck 'already covered the skyview' — but the Shinjuku day never happened, so the trip currently has ZERO skyviews. Harukas was the better-reviewed of the two Osaka options (glass-covered, so comfortable in heat; recommended for evening). Umeda Sky Building is the open-air alternative at the same ¥2,000." },
      ...
      notes:"⚠ RECALCULATED Aug 11: Omoide Yokocho never happened, so DOTONBORI IS NOW THE TRIP'S FIRST food-stall-alley evening, not a repeat. Worth doing properly rather than as a food-only stop. First day of Obon. Suitcase forwarded — check it arrived. Osaka Castle still OFF for arrival day. 06:45 Nara start tomorrow, so keep the evening from running long." },
    ...
    { date:"2026-08-22", stayId:"stay-ueno", title:"Last full day", status:"partial",
      ...
      candidates:[
        ...
        { id:"act-ameyoko-22", bucket:"activity", title:"Ameyoko — last souvenir window", walk:"5 min from Ueno Stn", cost:"¥",
          tags:["shopping","food-stalls"], tip:"400+ stores. The aquarium moved to Aug 12 (rain swap), so this day is back to being a genuine pack day with a souvenir run. Anything still unbought, buy it here.",
          link:"https://maps.google.com/?q=Ameyoko" },
      ],
      bench:[
      ...
      notes:"Pack day. Sumida Aquarium MOVED to Aug 12 when Nikko rained out — so this is light again: lunch, last souvenirs at Ameyoko, pack. Gap night already booked at the same hotel, no luggage scramble. Narita is early tomorrow." },
  ...
  irreversibles: [
    ...
    { id:"irr-kappabashi", due:"2026-08-12T17:00", title:"⚑ Kappabashi shops close ~17:00", detail:"Knife street closes earlier than you'd expect. Go BEFORE the aquarium, not after. Kama-Asa has English-speaking staff. Passport for tax-free over ¥5,500. If missed: Doguyasuji in Namba, Osaka — 2 stops from Hommachi, any afternoon Aug 14–16." },
    { id:"irr-aquarium",  due:"2026-08-12T19:00", title:"Sumida Aquarium LAST ENTRY 19:00 (Wednesday)", detail:"Moved here from Aug 22 after Nikko rained out. Weekday hours are 10:00–20:00 with last entry at 19:00 — tighter than Saturday would have been, so don't leave it to the evening." },
  ...
  reference: {
    ...
    cards: [
      ...
      { title:"⚑ RECALCULATED Aug 11 — the skyview is back",
        body:"The Shinjuku day (Aug 11) never happened — rain sent you to Ginza and Harajuku instead. Two earlier 'skip it, we already have one' rulings depended on that day: SKYVIEW — the trip now has ZERO. Abeno Harukas 300 (¥2,000, glass-covered, best for evening) or Umeda Sky Building (¥2,000, open-air) are both legitimate again on any Osaka evening. FOOD-STALL ALLEY — Omoide Yokocho was missed, so Dotonbori on Aug 13 is the FIRST instance, not a repeat; treat it as a real evening rather than a quick food stop. Also missed and not rescheduled: Don Quijote, Tsunahachi tempura. Ameyoko on Aug 22 is unaffected." },
